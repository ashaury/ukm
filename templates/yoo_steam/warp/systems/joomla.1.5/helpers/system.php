	...
	public function init() {
		...
		if ($this->application->isSite()) {
			...
			if (($this['config']->get('ie6page') && $this['browser']->isIE6()) || ($this['config']->get('outdated_browser') && $this['browser']->outdatedBrowser())) {
				$this['event']->bind('render.layouts:template', create_function('&$layout,&$args', '$args["title"] = JText::_("OUTDATEDBROWSER PAGE TITLE"); $args["error"] = "browser"; $args["message"] = JText::_("OUTDATEDBROWSER PAGE MESSAGE"); $layout = "layouts:error";'));
			}
