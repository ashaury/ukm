...
if (isset($head['metaTags']['standard'])) {
	foreach ($head['metaTags']['standard'] as $tag => $value) {
		if ($value == '' || $tag == 'title' || ($tag == 'robots' && $value == 'index, follow')) {
			unset($head['metaTags']['standard'][$tag]);
		}
	}
}
